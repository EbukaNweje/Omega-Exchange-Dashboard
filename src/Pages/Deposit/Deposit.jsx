          ...
          <div className="DepositContentLeft">
            ...
            <div className="DepositContentLeftDown">
              ...
              {walletAddress?.data?.map((item, index) => (
                <div className="DepositContentLeftDownInput" key={index}>
                  ...
                  <input
                    ...
                    name="b"
                    onChange={() => {
                      // Reset all flags first, then set the selected one
                      setBitcoin(false);
                      setDoge(false);
                      setEth(false);
                      setbnb(false);
                      ...
                      if (item.walletName === "Bitcoin") {
                        setBitcoin(true);
                      } else if (item.walletName === "Ethereum ") {
                        setEth(true);
                      ...
                      console.log(
                        "stored wallet id",
                        localStorage.getItem("selectedWalletId", item._id),
                      );
                    }}
                  />
                </div>
              ...
              <button
                ...
                style={{
                  background: `${isButtonDisabled ? "#E0E0E5" : "#0E4152"}`,
                }}
